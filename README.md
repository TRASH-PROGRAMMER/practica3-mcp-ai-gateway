...
## 🆕 Taller 3: Sistema MCP + IA (Gemini)

**NUEVO:** Integración de Model Context Protocol (MCP) con Gemini AI para consultas en lenguaje natural.

📚 **[Ver Documentación Completa del Taller 3](README_TALLER_3_MCP.md)**
